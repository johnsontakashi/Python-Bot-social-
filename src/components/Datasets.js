          ...
          <div key={dataset.id} className="dataset-card">
            <div className="dataset-header">
              ...
              <div className="dataset-actions">
                ...
                <button className="action-btn" title="Download Dataset" onClick={() => alert('Download dataset functionality would be implemented here')}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <button className="action-btn" title="Dataset Settings" onClick={() => alert('Dataset settings would open here')}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <circle cx="12" cy="12" r="3"></circle>
